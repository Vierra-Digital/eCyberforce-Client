  ...
  return (
    <div className={styles.Container}>
      <div className="flex">
        ...
        <div className="flex items-center justify-center flex-col text-center font-medium gap-6 lg:w-[700px] w-[550px] sm:w-[600px] lg:ml-24 sm:ml-6 ml-2 mt-10">
          ...
          <p className={`text-[16px] leading-[26px] ${sora.className}`}>
            Don't wait any longer, download our cyber solution today and ensure
        ...
        <div className="lg:mt-[-150px] mt-[-24px] w-fit">
          <Image src="/drone.png" alt="bug" width={500} height={100} className="w-[150px] sm:w-[300px] lg:w-[413px]"/>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-20 mt-10">
        <div className={`lg:flex block text-center gap-[42px] text-[14px] font-normal ${archivo.className}`}>
          <p className="mb-2 lg:mb-0">Copyright 2023 Alexersion LTD. All rights reserved. </p>
          <p>All code practices follow the MIT public developer license. All assets and materials registered in Cambridge Massachusetts</p>
        </div>
      </div>
    </div>
  );
...
const FooterLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { text: "Consulting Service", url: "/", key: "Consulting Service" },
      { text: "MacroProbe v1.3(Core License)", url: "/", key: "MacroProbe v1.3(Core License)" },
      { text: "MacroProbe v1.3(Distribution License)", url: "/", key: "MacroProbe v1.3(Distribution License)" },
    ],
  },
  {
    topic: "Resources",
